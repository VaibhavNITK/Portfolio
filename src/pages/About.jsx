      ...
      <div className='py-10'>
        ...
        <div className="mt-8 bg-slate-900 dark:bg-slate-950 text-white rounded-3xl p-6 sm:p-8 border border-slate-800 shadow-xl">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-white">Core Computer Science Fundamentals</h3>
              <p className="text-xs text-slate-400">Deep theoretical grounding and practical systems knowledge</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            {coreCSFundamentals.map((cs) => (
              <div key={cs.name} className="bg-slate-800/70 dark:bg-slate-900/80 p-4 rounded-2xl border border-slate-700/60">
                ...
                <p className="text-xs text-slate-400">{cs.desc}</p>
              </div>
            ))}
          </div>
        </div>
